...
public class ExpandableItemLayout extends LinearLayout {
    ...
    public ExpandableItemLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context);
    }
    ...
    public static interface OnExpandListener {
        public void onToggle(ExpandableItemLayout view, View child, boolean isExpanded);

        public void onExpandOffset(ExpandableItemLayout view, View child,
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.ExpandableItemLayout);
            canExpand = a.getBoolean(R.styleable.ExpandableItemLayout_canExpand,
                    false);
            isExpanded = a.getBoolean(R.styleable.ExpandableItemLayout_startExpanded,
                    false);
